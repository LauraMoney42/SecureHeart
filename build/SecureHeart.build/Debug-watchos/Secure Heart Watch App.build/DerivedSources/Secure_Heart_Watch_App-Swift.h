...
#ifndef SECURE_HEART_WATCH_APP_SWIFT_H
#define SECURE_HEART_WATCH_APP_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="Secure_Heart_Watch_App",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
# pragma pop_macro("any")
#endif

#if defined(__OBJC__)

SWIFT_CLASS("_TtC22Secure_Heart_Watch_App16HeartRateManager")
...
@class NSDate;
@interface HeartRateManager (SWIFT_EXTENSION(Secure_Heart_Watch_App)) <HKWorkoutSessionDelegate>
...
@class HKSampleType;
@interface HeartRateManager (SWIFT_EXTENSION(Secure_Heart_Watch_App)) <HKLiveWorkoutBuilderDelegate>
...
SWIFT_CLASS("_TtC22Secure_Heart_Watch_App24WatchConnectivityManager")
...
@class WCSession;
@class NSString;
@interface WatchConnectivityManager (SWIFT_EXTENSION(Secure_Heart_Watch_App)) <WCSessionDelegate>
