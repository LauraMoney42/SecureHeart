...
#ifndef SECURE_HEART_SWIFT_H
#define SECURE_HEART_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="Secure_Heart",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
# pragma pop_macro("any")
#endif

#if defined(__OBJC__)

SWIFT_CLASS("_TtC12Secure_Heart24WatchConnectivityManager")
...
@class WCSession;
@class NSString;
@interface WatchConnectivityManager (SWIFT_EXTENSION(Secure_Heart)) <WCSessionDelegate>
